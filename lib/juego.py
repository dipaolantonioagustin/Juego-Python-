...
class juego(object):
    ...
    def win_screen(self):
         ...
         text_surface2 = font2.render(f"Score {self.jugador.puntuacion}", True, WHITE)
         text_rect2 = text_surface2.get_rect()
         text_rect2.midtop=(ANCHO_PANTALLA/2,ALTO_PANTALLA/2)
         text_rect = text_surface.get_rect()
         text_rect.midtop=(ANCHO_PANTALLA/2,ALTO_PANTALLA/2)
         self.pantalla.blit(text_surface, (ANCHO_PANTALLA/2 - 150,ALTO_PANTALLA/2))
         self.pantalla.blit(text_surface2, (ANCHO_PANTALLA/2 - 90,ALTO_PANTALLA/2+80))
